function participants_ambig_proportions = monetary_mean_proportion(AMBIG_LEVEL, monetary_data, IGNORE_SLIGHT_IMPROVEMENT_COLUMN)
...
for ii = 1:length(AMBIG_LEVEL)
    ...
    current_ambig_data = monetary_ambiguity_mean_choice_for_level(monetary_data, ambig_level, IGNORE_SLIGHT_IMPROVEMENT_COLUMN);
